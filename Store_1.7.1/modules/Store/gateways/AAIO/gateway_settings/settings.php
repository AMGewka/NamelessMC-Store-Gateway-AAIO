...
if (Input::exists()) {
    if (Token::check()) {
        ...
        $settings = [
            'AAIO/shopid_key' => $_POST['shopid_key'],
            'AAIO/secret1_key' => $_POST['secret1_key'],
            'AAIO/secret2_key' => $_POST['secret2_key']
        ];
...
$smarty->assign([
    ...
    'SHOP_API_KEY_1_VALUE' => ((isset($_POST['secret1_key']) && $_POST['secret1_key']) ? Output::getClean(Input::get('secret1_key')) : StoreConfig::get('AAIO/secret1_key')),
